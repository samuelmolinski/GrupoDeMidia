	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Orange", "Blue", "Green", "Red", "Purple")),
		...
		array( "name" => "general-2",
			...
			array( "name" => esc_html__("Show Sidebar on the left on Homepage",$themename),
				   "id" => $shortname."_home_left_sidebar",
				   "type" => "checkbox",
				   "std" => "false",
				   "desc" => esc_html__("Enable this option to change the location of the sidebar on homepage",$themename)
			),
			   
			array( "name" => esc_html__("Display Video Slider",$themename),
                   "id" => $shortname."_video_slider_home",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => esc_html__("Here you can choose to display the Video Slider on the homepage. ",$themename)
			),
			
			array( "type" => "clearfix",),
			
			array( "name" => esc_html__("Number of posts in the Video slider",$themename),
                   "id" => $shortname."_video_postsnum",
                   "std" => '4',
                   "type" => "text",
				   "desc" => esc_html__("Here you can choose the number of posts to display in the Video Slider. ",$themename)
			),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => esc_html__("Enable 468x60 Header banner",$themename),
				   "id" => $shortname."_468_header_enable",
				   	"type" => "checkbox2",
				   "std" => "false",
				   "desc" => esc_html__("Enabling this option will display a 468x60 banner ad next to the logo. If enabled you must fill in the banner image and destination url below.",$themename)
			),

			array( "type" => "clearfix",),
			
			array( "name" => esc_html__("Enable 728x90 Footer banner",$themename),
				   "id" => $shortname."_728_enable",
				   	"type" => "checkbox",
				   "std" => "false",
				   "desc" => esc_html__("Enabling this option will display a 468x60 banner ad next to the logo. If enabled you must fill in the banner image and destination url below.",$themename)
			),
			...
			array( "name" => esc_html__("Input 468x60 advertisement banner image ( Header area )",$themename),
				   "id" => $shortname."_468_header_image",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => esc_html__("Place the file URL of the image here. ",$themename)
			),

			array( "name" => esc_html__("Input 468x60 advertisement destination url ( Header area )",$themename),
				   "id" => $shortname."_468_header_url",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("Place the destination URL here. ",$themename)
			),
				   
			array( "name" => esc_html__("Input 468x60 adsense code ( Header area )",$themename),
				   "id" => $shortname."_468_header_adsense",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => esc_html__("Place your adsense code here.",$themename)
			),
			
			array( "name" => esc_html__("Input 728x90 advertisement banner image ( Footer area )",$themename),
				   "id" => $shortname."_728_image",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => esc_html__("Place the file URL of the image here. ",$themename)
			),

			array( "name" => esc_html__("Input 728x90 advertisement destination url ( Footer area )",$themename),
				   "id" => $shortname."_728_url",
				   "type" => "text",
				   "std" => "",
				   "desc" => esc_html__("desc",$themename)
			),
				   
			array( "name" => esc_html__("Input 728x90 adsense code ( Footer area )",$themename),
				   "id" => $shortname."_728_adsense",
				   "type" => "textarea",
				   "std" => "",
				   "desc" => esc_html__("Place your adsense code here. ",$themename)
			),
