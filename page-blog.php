					...
					<div id="et_pt_blog" class="responsive">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_blogentry clearfix">
								...
								<p class="et_pt_blogmeta"><?php esc_html_e('Postado: ','Lucid'); ?> <?php esc_html_e('por: ','Lucid'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('em: ','Lucid'); ?> <?php the_time(get_option('lucid_date_format')) ?> <?php esc_html_e('de: ','Lucid'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comentários','Lucid'), esc_html__('1 comentários','Lucid'), '% '.esc_html__('comentários','Lucid')); ?></p>
								...
								<?php if (!$et_ptemplate_blogstyle) { ?>
									...
									<a href="<?php the_permalink(); ?>" class="readmore"><span><?php esc_html_e('Leia mais','Lucid'); ?></span></a>
								<?php } else { ?>
									<?php
										global $more;
										$more = 0;
